...
with map_face_mesh.FaceMesh(refine_landmarks=True, min_detection_confidence =0.5, min_tracking_confidence=0.8) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if IsBlinking(mesh_coords,RIGHT_EYE,LEFT_EYE):
                ...
                if CEF_COUNTER>fps*2:
                  ...
                  utils.colorBackgroundText(frame,  f'Blink', FONTS, 1.7, (450, 50), 2, utils.YELLOW, pad_x=6, pad_y=6, )
            else:
        ...
        utils.colorBackgroundText(frame,  f'Blink frequency: {round(blinkFrequency,2)}', FONTS, 0.7, (30,30),2, utils.ORANGE, utils.GRAY)
        utils.colorBackgroundText(frame,  f'Total blnks: {round(TOTAL_BLINKS,2)}', FONTS, 0.7, (30,55),2, utils.PINK, utils.GRAY)
